...
![포스터_수정](https://github.com/kookmin-sw/eureka-253-team-e25-ai01-08/blob/main/8%ED%8C%80_%ED%8F%AC%EC%8A%A4%ED%84%B0.jpg)
...
## 3주차 활동
  - IMAGE_1
    ...
    - **상황 요약**  
		...
		- 건축 현장에서는 3D 프린팅 로봇이 건물을 제작 중.
    - **포함 기술**  
		- 🚁 **드론 택시 / 자율주행 자동차** – 차세대 이동수단, 교통 효율화 및 안전성 강화  
		- 💬 **AI 비서(홀로그램)** – 음성 및 제스처 인식 기반의 개인 맞춤형 정보 서비스  
  ...
  - IMAGE_2
    ...
    - **포함 기술**  
		- 🧱 **지속가능 건축 기술** – 재활용 소재, 저비용·고효율 3D 프린팅 구조물  
		- 🤖 **AI 건설 로봇** – 자동 시공 및 자율 제어 기능  
  ...
  - IMAGE_3
    ...
    - **포함 기술**  
		- 🚁 **드론 택시 / 자율주행 차량** – 하늘·도로 통합 이동 인프라  
		- 🪞 **스마트 미러(AR)** – 증강현실 기반의 의류 피팅 및 실시간 피드백  
		- 💬 **AI 비서 & 로봇 어시스턴트** – 감정 기반 대화형 스마트 홈 관리  
		- 🍽️ **푸드 프린터** – 맞춤형 식단 출력 및 자동 조리 시스템  
		- 🌿 **스마트 홈 에너지 제어** – 실내 조명·온도 자동 제어 및 에너지 효율 극대화  
...
- 멘토링 ✔️  
  - 내 지도 교수 함게 만나기
    - **인터뷰: 전자공학부 교수 박준석**
    - 나현우
      - 교수님과의 면담을 통해 연구와 진로의 방향성을 한층 명확하게 정립할 수 있었습니다. 짧은 시간이었지만 교수님의 조언 덕분에 그동안 간과하고 있던 부분들을 깨닫게 되었고, 그 결과 연구에 대한 동기부여도 한층 강화되었습니다. 또한 이번 만남을 통해 인공지능학부에서 앞으로 배우게 될 내용과 이에 대비해 어떤 역량을 길러야 할지 구체적으로 알게 되었습니다. 이러한 깨달음 덕분에 전공에 대한 흥미와 목표 의식이 더욱 확고해졌습니다. 특히 인공지능 분야에서는 수학적 사고력이 중요하다는 사실을 절감했고, 다음 기회에는 더 깊이 있는 질문을 준비해 교수님께 여쭤보고 싶다는 생각이 들었습니다.
    - 류승목
      - 지도교수님과의 만남을 통해 앞으로의 연구 방향을 보다 분명하게 잡을 수 있었다. 조언을 들으며 내가 놓치고 있던 부분을 깨닫게 되었고, 연구에 대한 동기 또한 더욱 높아졌다. 짧은 시간이었지만 유익하고 의미 있는 만남이었다.
    - 장형진
      - 지도교수님과의 만남을 통해 학과에서 어떤 학습이 이루어지고, 실제 연구가 어떤 방식으로 진행되는지 이해할 수 있었다. 교수님의 경험을 들으며 내가 앞으로 보완해야 할 점을 깨닫게 되었고, 목표를 향해 더 체계적으로 준비해야겠다는 마음이 생겼다. 의미 있는 상담 시간이었다.
    - 민은진
      - 지도교수님과의 만남을 통해 진로를 구체적으로 설계하는 데 큰 도움이 되었습니다. 특히  앞으로 어떤 역량을 키워야 할지 알게 되어  동기부여가 되었습니다.  교수님과의 만남 활동 덕분에 전공에 대한 흥미와 목표의식을 확실히 다질 수 있었습니다.
    - 안성훈
      - 지도교수님과의 면담을 통해 인공지능학부에서 어떤 내용을 배우는지 이해할 수 있었고, 앞으로 내가 어떤 준비를 해야 할지 고민해 보는 계기가 되었습니다. 특히 인공지능 분야에서 수학적 사고력이 얼마나 중요한지를 깨닫게 되었으며, 향후 기회가 된다면 보다 깊이 있는 질문을 준비하고 교수님께 여쭙고 싶다는 생각이 들었습니다.
    - ![교수_인터뷰](https://github.com/kookmin-sw/eureka-253-team-e25-ai01-08/blob/main/%EA%B5%90%EC%88%98_%EC%9D%B8%ED%84%B0%EB%B7%B0.jpg)
  - 대학원 방문 및 선배 만나기
    - **인터뷰: 전자공학전공 박사과정 대학원생 안수빈**
    - 나현우
      - 이번에 대학원 선배님과 대화를 나누면서, 인공지능을 본격적으로 탐구한다는 것이 기술을 익히는 것 이상이라는 생각이 들었습니다. “문제를 정의하는 깊이”가 중요하다는 말씀은 지금까지 미처 깨닫지 못했던 부분이었습니다.<br>현재 인공지능은 여러 분야와 교차되면서 새로운 문제 해결 방식을 요구합니다. 단순히 한 분야에 집중하는 대신, 다양한 지식을 융합해 새로운 관점에서 문제를 바라볼 줄 아는 역량이 필요하다는 조언이 인상 깊었습니다. 이를 바탕으로 앞으로는 단순한 전공 공부 이후에 “실질적인 문제 해결력”을 키우는 방향으로 학습 전략을 바꾸고자 합니다.<br>또한 연구 활동이 꾸준한 노력과 균형 잡힌 자세에서 이뤄진다는 것을 알게 되었습니다. 지식을 깊이 있게 쌓는 동시에 이를 현실과 연결하려는 태도가 연구자의 삶을 지탱하는 밑거름이라는 것도 느꼈습니다.<br>이 경험을 통해 저는 인공지능학부에서의 배움이 단순히 지식을 채우는 과정이 아니라, 저만의 질문을 세우고 답을 찾아가는 여정이라는 것을 깨달았습니다. 앞으로는 주어진 지식을 적용하는 데 머무르지 않고, 스스로 문제를 설정하고 해결책을 고민하는 태도를 갖고 나아가겠습니다.
    - 류승목
      - 대학원생을 만나 이야기를 나누면서 전공 분야에 대한 깊이 있는 시각과 연구 경험에서 나오는 차분한 태도가 인상적이었다. 학문적 호기심뿐 아니라 꾸준함이 얼마나 중요한지도 실감할 수 있었다. 덕분에 대학원 생활이 막연하게 어렵기만 한 것이 아니라, 분명한 목표를 가지고 꾸준히 나아가는 과정이라는 점을 이해하게 되었다.<br>짧은 만남이었지만, 학문을 깊이 있게 탐구한다는 것이 어떤 의미인지 다시 생각하게 만든 뜻깊은 시간이었다.
    - 장형진
      - 대학원 선배님과의 만남을 통해 인공지능학부에서 어떤 방향으로 공부해야 할지 분명한 기준을 세울 수 있었습니다. 인공지능이 여러 분야를 융합하는 흐름 속에서 필요한 역량과 앞으로 중요해질 기술들에 대해 구체적인 조언을 들으며 큰 도움을 받았습니다. 선배님의 실제 연구 경험을 바탕으로 한 현실적인 조언 덕분에 진로와 학업 목표가 더욱 명확해졌고, 앞으로의 준비 방향도 확실히 잡을 수 있었습니다.
    - 민은진
      - 이번 대학원 선배님과의 만남으로 평소 가지고 있던 인공지능 분야 심화 연구에 대한 막연한 궁금증과 대학원 생활의 현실적인 모습에 대한 구체적인 조언을 얻었습니다. 특히, 학부생으로서 현재 무엇을 준비해야 하는지에 대한 구체적인 조언을 얻을 수 있었고, 이를 통해 얻은 통찰을 바탕으로 앞으로 남은 학부 기간 동안 연구 역량을 더욱 집중적으로 키워나갈 계획입니다.
    - 안성훈
      - 인공지능관련 학과는 대학원을 나와야 취업을 할 수 있다고 들었는데 이번 대학원생과의 만남에서 꼭 대학원을 나오지 않아도 취업의 문이 열려있다는 말을 듣고 학부 졸업 이후 무엇을 해야할지 좀 더 고민 해볼 수 있는 계기가 된 거 같다. 다양한 정보를 얻어갈 수 있었고 다음에 또 기회가 된다면 만나뵙고싶다.
  	- ![대학원생_인터뷰](https://github.com/kookmin-sw/eureka-253-team-e25-ai01-08/blob/main/%EB%8C%80%ED%95%99%EC%9B%90%EC%83%9D_%EC%9D%B8%ED%84%B0%EB%B7%B0.jpg)
